          ...
          <div className="detailMainGrid">
            ...
            <div className="detailInfo">
              ...
              <div className="detailTags">
                <button className="tagBtn" type="button">
                  Funny
                </button>
                <button className="tagBtn" type="button">
                  Fandom
              ...
              <div className="detailDesc">
                <p>
                  ...
                  국내에서는 2010년대 농구선수 마이클 조던을 &apos;GOAT&apos;라고 부르며 널리 사용되기
                  시작했습니다. 이후 메시, 호날두 등 다양한 스포츠 스타에게 적용되면서 수많은 변형 밈이
                  생성되었고, 현재는 스포츠 분야를 넘어 인터넷 전반에서 &apos;레전드&apos;, &apos;GOD&apos;과
                  유사한 의미로 사용됩니다.
                </p>
                <p>
                  GOAT는 뛰어나고 훌륭한 대상에 감탄을 표현할 때 쓰이며, 염소 이모티콘과 함께 활용되거나
                  다양한 합성 밈 형태로 변주되기도 합니다. 예를 들어 &apos;그저 GOAT&apos;, &apos;또
                  당신입니까 GOAT&apos;처럼 대상에 대한 존경과 찬사를 강조하는 문구로 자주 사용됩니다.
                </p>
              </div>
            </div>
          </div>
